...
<div class="all_events">
  <div class="container">
    <div class="header_wraper">
      <h2 class="wow bounceIn" data-wow-duration="1.5s" data-wow-delay="0.3s"> All Events </h2>
    </div>

    <div class="events_wraper">
      <div class="single_event_wraper row justify-content-between p-2 my-3 overflow-hidden">
      ...
      <div class="single_event_wraper row justify-content-between p-2 my-3 overflow-hidden">
        ...
        <div class="col-12 col-md-5 my-2 wow fadeInRightBig" data-wow-duration="1.5s" data-wow-delay="0.3s">
          <div class="event_img_wraper">
            <img src="./assets/media/pic2.jpg" alt="about us iamge">
      ...
      <div class="single_event_wraper row justify-content-between p-2 my-3 overflow-hidden">
        ...
        <div class="col-12 col-md-5 my-2 wow fadeInRightBig" data-wow-duration="1.5s" data-wow-delay="0.3s">
          <div class="event_img_wraper">
            <img src="./assets/media/pic18.jpg" alt="about us iamge">
